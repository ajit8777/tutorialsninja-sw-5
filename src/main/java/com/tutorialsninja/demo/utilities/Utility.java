...
public class Utility extends ManageBrowser {
    ...
    public WebElement webElementList(WebElement element) {
        return element;
    }
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/tutorialninja/demo/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/demo/tutorialninja/screenshots/" + screenshotName + dateName + ".png";
    ...
    public boolean selectRadioButton(WebElement element, String name){
